-- ============================================================
-- TEARDOWN (runs first — safe even on a blank database)
-- ============================================================
DROP VIEW  IF EXISTS v_low_stock                CASCADE;
DROP VIEW  IF EXISTS v_monthly_business_summary CASCADE;
DROP VIEW  IF EXISTS v_order_profit             CASCADE;
...
DROP TABLE IF EXISTS waybill_batch_orders  CASCADE;
DROP TABLE IF EXISTS waybill_batches       CASCADE;
DROP TABLE IF EXISTS waybill_batch_counter CASCADE;
DROP TABLE IF EXISTS order_timeline        CASCADE;
DROP TABLE IF EXISTS order_items           CASCADE;
DROP TABLE IF EXISTS order_number_counter  CASCADE;
...
DROP FUNCTION IF EXISTS recalculate_order_total()           CASCADE;
DROP FUNCTION IF EXISTS auto_order_timeline_on_status()     CASCADE;
DROP FUNCTION IF EXISTS auto_set_payment_confirmed()        CASCADE;
DROP FUNCTION IF EXISTS generate_batch_number()             CASCADE;
DROP FUNCTION IF EXISTS recalculate_waybill_total()         CASCADE;
DROP FUNCTION IF EXISTS equalise_batch_allocated_costs()    CASCADE;
DROP FUNCTION IF EXISTS apply_inventory_movement()          CASCADE;
DROP FUNCTION IF EXISTS generate_doc_number()               CASCADE;
DROP FUNCTION IF EXISTS auto_resolve_order_alerts()         CASCADE;

-- ============================================================
-- END TEARDOWN — schema creation starts below
-- ============================================================
